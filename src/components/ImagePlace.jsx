export default function ImagePlace({ url, imageUrl, children, largeImage = false }) {
    return (
        <a href={url}
            className={`rounded-lg sm:rounded-xl lg:rounded-2xl overflow-hidden min-w-32 min-h-32 sm:min-w-36 sm:min-h-36 lg:min-w-44 lg:min-h-44 ${largeImage && 'xl:min-w-64 xl:min-h-64'} relative`}>
